...
export default function BusesAdminPage() {
 ...
 <h3 className="text-lg font-bold text-gray-950">¿Eliminar esta Unidad?</h3>
 ...
 className="px-4 py-2 text-sm font-semibold text-gray-600 hover:bg-gray-50 border border-gray-200 rounded-xl transition"
 >
 Cancelar
 </button>
 <button 
 ...
 <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-5 border border-gray-200 rounded-2xl shadow-sm">
 <div className="flex items-center space-x-3.5">
 <div className="bg-blue-600 p-2.5 rounded-xl text-white">
 <Bus className="h-6 w-6" />
 </div>
 <div>
 <h1 className="text-xl font-bold text-gray-950">Gestión de Buses</h1>
 <p className="text-xs text-gray-500 mt-0.5">Mapea la flota vehicular y gestiona categorías tarifarias de asientos.</p>
 </div>
 </div>
 ...
 {buses.map((bus) => (
 <tr key={bus.id} className="hover:bg-gray-50/50 transition">
 ...
 <p className="font-semibold text-gray-800">{bus.marcaChasis || "Mercedes-Benz"}</p>
 <p className="text-xs text-gray-400 mt-0.5">{bus.marcaCarroceria || "Marcopolo"}</p>
 </td>
 ...
 {selectedBusMap ? (
 <div className="bg-gray-900 text-white p-6 rounded-2xl border border-gray-800 shadow-xl space-y-6 sticky top-6">
 ...
 <span className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Leyenda Tarifaria</span>
 <div className="grid gap-2 text-xs">
 {selectedBusMap.categorias.map((cat, idx) => (
 <div key={idx} className="flex items-center justify-between p-2 rounded-xl bg-gray-950/40 border border-gray-800">
 <div className="flex items-center space-x-2">
 ...
 <div className="bg-gray-950 rounded-2xl border border-gray-800 p-4 relative">
 {/* Cabina del Conductor */}
 <div className="h-10 border-b border-dashed border-gray-800 mb-6 flex items-center justify-between px-3 text-gray-500 text-[10px] font-bold uppercase">
 <span>Conductor </span>
 <span>Puerta </span>
 </div>
 ...
 <div className="absolute top-[48px] bottom-4 left-1/2 -trangray-x-1/2 w-4 bg-gray-950/90 border-l border-r border-dashed border-gray-800 pointer-events-none flex items-center justify-center">
 <span className="text-[8px] text-gray-700 uppercase tracking-widest rotate-90">Pasillo</span>
 </div>
 </div>

 <div className="bg-gray-950/40 p-3 rounded-xl border border-gray-800 flex items-start space-x-2 text-[11px] text-gray-400 leading-relaxed">
 ...
 <div className="bg-white border border-gray-200 rounded-2xl p-6 text-center shadow-sm sticky top-6">
 <div className="bg-gray-50 p-3.5 rounded-full inline-block text-gray-400 mb-3.5">
 <Eye className="h-6 w-6" />
 </div>
 <h3 className="font-bold text-gray-950">Visualizar Planos</h3>
 ...
 <div className="bg-white rounded-2xl border border-gray-200 shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-scale-up">
 ...
 <h4 className="text-xs font-bold text-blue-600 uppercase tracking-widest border-b border-gray-100 pb-1">Parámetros Vehiculares</h4>
 
 <div className="space-y-1.5">
 <label htmlFor="bus-numero" className="block text-xs font-semibold uppercase tracking-wider text-gray-500">Disco / Registro Nro. *</label>
 <input
 id="bus-numero"
 type="text"
 value={numero}
 ...
 className="w-full px-3.5 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none text-sm bg-gray-50/50 focus:bg-white text-gray-900 font-mono disabled:opacity-60"
 />
 </div>

 <div className="space-y-1.5">
 <label htmlFor="bus-placa" className="block text-xs font-semibold uppercase tracking-wider text-gray-500">Placa Vehicular *</label>
 <input
 id="bus-placa"
 type="text"
 maxLength={8}
 ...
 required
 className="w-full px-3.5 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none text-sm bg-gray-50/50 focus:bg-white text-gray-900 font-mono"
 />
 </div>
 </div>
 ...
 <div className="space-y-4">
 <h4 className="text-xs font-bold text-blue-600 uppercase tracking-widest border-b border-gray-100 pb-1">Marca e Ingeniería</h4>
 
 <div className="space-y-1.5">
 <label htmlFor="bus-chasis" className="block text-xs font-semibold uppercase tracking-wider text-gray-500">Marca del Chasis *</label>
 <input
 id="bus-chasis"
 type="text"
 value={marcaChasis}
 ...
 required
 className="w-full px-3.5 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none text-sm bg-gray-50/50 focus:bg-white text-gray-900"
 />
 </div>

 <div className="space-y-1.5">
 <label htmlFor="bus-carroceria" className="block text-xs font-semibold uppercase tracking-wider text-gray-500">Marca de Carrocería *</label>
 <input
 id="bus-carroceria"
 type="text"
 ...
 {/* Fotografía URL */}
 <div className="space-y-1.5">
 <label htmlFor="bus-fotografia" className="block text-xs font-semibold uppercase tracking-wider text-gray-500">Fotografía o Imagen URL</label>
 <input
 id="bus-fotografia"
 type="text"
 value={fotografiaUrl}
 ...
 {editingBus && (
 <div className="bg-gray-50 p-4 rounded-xl border border-gray-200/80 grid gap-4 sm:grid-cols-2">
 ...
 />
 <label htmlFor="edit-terminal" className="text-xs font-bold text-gray-700 cursor-pointer">Unidad disponible en Terminal</label>
 </div>
 <div className="flex items-center space-x-2.5">
 <input 
 type="checkbox" 
 ...
 className="rounded text-blue-600 focus:ring-blue-500 border-gray-300"
 />
 <label htmlFor="edit-activo" className="text-xs font-bold text-gray-700 cursor-pointer">Unidad de transporte Activa</label>
 </div>
 </div>
 )}
 ...
 <div key={cat.id} className="p-3.5 rounded-xl border border-gray-200/80 flex items-start justify-between bg-gray-50/50">
 <div>
 <p className="text-sm font-bold text-gray-900">{cat.nombre}</p>
 <p className="text-xs text-gray-500 mt-1 font-mono">${Number(cat.precioBase).toFixed(2)} • {cat.cantidad} Asientos</p>
 </div>
 <button
 type="button"
 ...
 <div key={idx} className="p-4 rounded-xl border border-gray-200/80 bg-gray-50/50 grid gap-3 sm:grid-cols-12 items-center relative">
 {/* Input de Nombre */}
 <div className="sm:col-span-4 space-y-1">
 <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Nombre Categoría</label>
 <input 
 type="text" 
 required 
 value={cat.nombre}
 ...
 className="w-full px-3 py-1.5 border border-gray-200 rounded-lg text-xs outline-none focus:border-blue-500 bg-white"
 />
 </div>

 {/* Input de Precio */}
 <div className="sm:col-span-3 space-y-1">
 <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Precio Base ($)</label>
 <input 
 type="number" 
 required 
 step="0.01"
 ...
 className="w-full px-3 py-1.5 border border-gray-200 rounded-lg text-xs outline-none focus:border-blue-500 bg-white font-mono"
 />
 </div>

 {/* Input de Cantidad */}
 <div className="sm:col-span-3 space-y-1">
 <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Nro. Asientos</label>
 <input 
 type="number" 
 required 
 min="1"
 ...
 {isCategoryModalOpen && (
 <div className="fixed inset-0 z-[60] flex items-center justify-center bg-gray-950/45 backdrop-blur-sm p-4 animate-fade-in">
 <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-2xl max-w-md w-full">
 <div className="flex items-center justify-between border-b border-gray-100 pb-3 mb-4">
 <h3 className="font-bold text-gray-950">Añadir Nueva Categoría</h3>
 <button 
 ...
 <div className="space-y-1.5">
 <label className="block text-xs font-semibold uppercase tracking-wider text-gray-500">Nombre de la Categoría *</label>
 <input 
 type="text" 
 required 
 value={catNombre}
 ...
 <div className="space-y-1.5">
 <label className="block text-xs font-semibold uppercase tracking-wider text-gray-500">Precio Base ($) *</label>
 <input 
 type="number" 
 required 
 step="0.01"
 ...
 className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm outline-none font-mono"
 />
 </div>

 <div className="space-y-1.5">
 <label className="block text-xs font-semibold uppercase tracking-wider text-gray-500">Nro. de Asientos *</label>
 <input 
 type="number" 
 required 
 min="1"
 ...
 <div className="space-y-1.5">
 <label className="block text-xs font-semibold uppercase tracking-wider text-gray-500">Descripción Corta</label>
 <textarea 
 value={catDescripcion}
 onChange={(e) => setCatDescripcion(e.target.value)}
 placeholder="Detalles sobre los asientos de esta categoría..."
 className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm outline-none h-20 resize-none"
 />
 </div>
