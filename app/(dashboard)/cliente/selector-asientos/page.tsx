  ...
  if (!rutaId) {
    return (
      <div className="min-h-screen bg-gray-100 p-8">
        <div className="mx-auto max-w-2xl rounded-lg border border-amber-200 bg-white p-6 text-center shadow">
          ...
          <Link
            ...
            className="mt-5 inline-flex rounded-md bg-amber-500 px-4 py-2 text-sm font-semibold text-white hover:bg-amber-600"
          >
