  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-xl z-50 p-6 sm:p-8 max-h-[90vh] overflow-y-auto">
          <div className="flex justify-between items-center mb-6">
            <Dialog.Title className="text-xl font-bold text-gray-900">Habilitar Nueva Ruta</Dialog.Title>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="date" value={fecha} onChange={(e) => setFecha(e.target.value)}
                  ...
                  className="w-full pl-11 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-600 outline-none" required />
              </div>
              <p className="text-xs text-gray-500 mt-1.5">Debe estar entre {inicioRango} y {finRango}</p>
            </div>
